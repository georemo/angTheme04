        ...
        <div class="col-sm-12">
          <div class="tabbable">
            <ul class="nav nav-tabs tab-padding tab-space-3 tab-blue" id="myTab4">
              <li class="active">
                <a data-toggle="tab" href="pages_user_profile.html#panel_overview" aria-expanded="true">
                  Overview
                </a>
              </li>
              <li class="">
                <a data-toggle="tab" href="pages_user_profile.html#panel_edit_account" aria-expanded="false">
                  Edit Account
                </a>
              </li>
              <li class="">
                <a data-toggle="tab" href="pages_user_profile.html#panel_projects" aria-expanded="false">
                  Projects
                </a>
              </li>
            </ul>
                ...
                <div class="row">
                        ...
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                          <div class="user-image">
                            ...
                            <div class="user-image-buttons">
                              ...
                              <a href="pages_user_profile.html#" class="btn fileupload-exists btn-red btn-sm" data-dismiss="fileupload">
                      ...
                      <table class="table table-condensed table-hover">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href="pages_user_profile.html#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
                          </tr>
                          <tr>
                            <td>email:</td>
                            <td>
                  ...
                  <div class="col-sm-7 col-md-8">
                    ...
                    <div class="row space20">
                      ...
                      <div class="col-sm-3">
                        <button class="btn btn-icon btn-block pulsate" style="-moz-outline-radius: 2px; outline: currentcolor none 0px; outline-offset: 10px;">
                    ...
                    <div class="panel panel-white space20">
                      <div class="panel-heading">
                        ...
                        <div class="panel-tools">
                          <a class="btn btn-xs btn-link panel-close" href="pages_user_profile.html#">
                            <i class="fa fa-times"></i>
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: -128px; width: 698px; display: none;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 131px; right: 3px; height: 270px; display: inherit;"><div class="ps-scrollbar-y" style="top: 82px; height: 169px;"></div></div></div>
                    </div>
                    <div class="panel panel-white space20">
                      <div class="panel-heading">
                      ...
                      <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px; width: 698px; display: none;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; right: 3px; height: 270px; display: inherit;"><div class="ps-scrollbar-y" style="top: 0px; height: 161px;"></div></div></div>
                    </div>
                  </div>
                </div>
              </div>
              <div id="panel_edit_account" class="tab-pane fade">
                <form action="pages_user_profile.html#" role="form" id="form">
                  <div class="row">
                    <div class="col-md-12">
                      <h3>Account Info</h3>
                      <hr>
                      ...
                      <div class="form-group">
                        ...
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                          ...
                          <div class="user-edit-image-buttons">
                            ...
                            <a href="pages_user_profile.html#" class="btn fileupload-exists btn-red" data-dismiss="fileupload">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <div class="visible-md visible-lg hidden-sm hidden-xs">
                        <a href="pages_user_profile.html#" class="btn btn-light-blue tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                        <a href="pages_user_profile.html#" class="btn btn-green tooltips" data-placement="top" data-original-title="Share"><i class="fa fa-share"></i></a>
                        <a href="pages_user_profile.html#" class="btn btn-red tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>
                      </div>
